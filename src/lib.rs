...
#[derive(Debug)]
pub struct NestBackendProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NestBackendProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NestBackend processing");
    
    let mut processor = NestBackendProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NestBackendProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NestBackendProcessor::new(false);
